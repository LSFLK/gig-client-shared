...
class MainContentItem extends Component {
    ...
    render() {
        ...
        const {classes, imageUrl, title, subtitle, description, categories, elevation, entityRoute, searchRoute} = this.props;
        return (
            <Paper className={classes.paper} elevation={elevation}>
                <ListItem alignItems="flex-start">
                    <Grid container width={1}>
                        <Grid item lg={5}>
                            <Link className={classes.itemLink} to={entityRoute + title}>
